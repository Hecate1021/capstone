...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <p></p>
            <p>Their is a new booking for the event:</p>
            <h3 style="color: #1a73e8;">{{ $event->event_name }}</h3>
            ...
            <p>Please check the dashboard to confirm the event booking</p>


            <!-- Action Button -->
            <div style="text-align: center;">
                <a href="{{ route('booking.event') }}" class="btn">View Dashboard</a>
            </div>
