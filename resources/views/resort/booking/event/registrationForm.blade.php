...
<div class="container">
    ...
    <div class="personal-info">
        ...
        <div class="info-row">
            ...
            <span class="info-label">Arrival Date:<u>{{$booking->event->event_start}}</u></span>
        </div>
        <div class="info-row">
            <span class="info-label">Contact Number: <u>{{$booking->contact}}</u></span>
            <span class="info-label">Departure Date:<u>{{$booking->event->event_end}}</u></span>
        </div>
        <div class="info-row">
