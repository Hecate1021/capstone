...
@section('content')
    ...
    <div class="p-6 sm:ml-64 mt-10">
        <div class="bg-white p-8 rounded-lg shadow-lg dark:border-gray-700 dark:bg-gray-900">
            ...
            <form action="{{ route('eventBookings.updateStatus', $booking->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div data-group-id="3">
                    <div>
                        ...
                        <input type="number" value="{{ $booking->payment }}" name="payment" id="payment"
                            class="payment mt-2 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-md p-3 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600">
                    </div>
