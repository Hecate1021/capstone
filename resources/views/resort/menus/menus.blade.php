                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5">
                                            ...
                                            <form action="{{ route('menus.update', $menu->id) }}" method="POST"
                                                ...
                                                <!-- Category Dropdown -->
                                                <div class="mb-4">
                                                    <label for="category-{{ $menu->id }}"
                                                        class="block text-sm font-medium text-gray-700 dark:text-gray-400">
                                                        Category
                                                    </label>
                                                    <select name="category_id" id="category-{{ $menu->id }}"
                                                        class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                                ...
                                                <div class="mb-4">
                                                    <label for="subcategory-{{ $menu->id }}"
                                                        class="block text-sm font-medium text-gray-700 dark:text-gray-400">
                                                        Subcategory
                                                    </label>
                                                    <select name="subcategory_id" id="subcategory-{{ $menu->id }}"
                                                        class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                                        <option value="" disabled>Select Subcategory</option>
                                                        @foreach ($subcategories as $subcategory)
                                                            <option value="{{ $subcategory->id }}"
                                                                {{ $menu->subcategory_id == $subcategory->id ? 'selected' : '' }}>
                                                                {{ $subcategory->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
